...
/* cool
apparently the semicolon isn't necessary? */
...
console.log (Math.sqrt(9) + '7');
/* 
console.log ("one" + " " + 1) console.log ("two" + " " + 2)
it doesn't like that one lol*/
console.log ("one" + " " + 1); console.log ("two" + " " + 2) 
/* OH the semicolon does do something!...I'll use them from now on, just in case.*/

console.log ("\"The abuse of greatness is when it disjoins remorse from power\"" +
"\n-William Shakespeare, in the play \"Julius Caesar\"");